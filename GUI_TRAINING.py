...
class App(QWidget):
    ...
    def start(self):  # start the app
        self.ui = uic.loadUi('C:/Users/HP/PycharmProjects/project/train.ui')
        self.ui.show()
    ...
    def ui_init_set(self):  # settings window
        ...
        self.ui.help_btn.hide()

    def help_btn(self):
        self.ui.help_btn.clicked.connect(lambda: self.help_event())

    def help_event(self):
        if self.flag != 0:
            if self.flag == 1:
                self.ui.help_lbl.setText(f'D = {self.d}\nx1 = {self.x1}\nx2 = {self.x2}')
            elif self.flag == 2:
                self.ui.help_lbl.setText(f'x = {self.x}')
    ...
    def show_info(self):  # scd window with instruction
        self.ui_info = uic.loadUi('C:/Users/HP/PycharmProjects/project/instruction.ui')
